...
<body>
	...
	<!-- Bootstrap -->
	<script src="<?= public_url(); ?>libraries/bootstrap/js/bootstrap.min.js"></script>jk
	...
	<script type="text/javascript" src="https://cdn.datatables.net/v/bs4-4.1.1/jq-3.3.1/jszip-2.5.0/b-1.6.1/b-html5-1.6.1/b-print-1.6.1/datatables.min.js"></script>
